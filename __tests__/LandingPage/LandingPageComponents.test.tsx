...
describe("Layout Elements of Landing Page", () => {
  describe("Rendering", () => {
    it("should have a Navbar component with logo and 2 buttons", () => {
      ...
      expect(screen.getByTestId("logo")).toHaveTextContent("FlowBoard");
      ...
      expect(
        screen.getByTestId("navbar_get_FlowBoard_button")
      ).toBeInTheDocument();
      expect(screen.getByTestId("navbar_get_FlowBoard_button")).toHaveTextContent(
        "Get FlowBoard for free"
      );
      expect(
        screen.getByTestId("navbar_get_FlowBoard_button").closest("a")
